...
# Proper FP8 Training Script using Accelerate Config
# This is the OFFICIAL way to use FP8 with HuggingFace Trainer
...
echo "=================================================="
echo "FP8 Training with Accelerate Config (PROPER WAY)"
echo "=================================================="
...
# Enable Transformer Engine debug logging
export NVTE_DEBUG=1
...
# This is the OFFICIAL way to use FP8 with Trainer!
accelerate launch \
  ...
  --logging_steps 5 \
  --save_steps 1000 \
  --output_dir /workspace/checkpoints/qwen-7b-fp8-proper \
  --overwrite_output_dir true \
  --ddp_timeout 180000000 \
  --plot_loss true 2>&1 | tee /tmp/fp8_proper.log

echo ""
echo "Training complete! Logs saved to /tmp/fp8_proper.log"
echo ""
